...
void BPS::optimizeAlg(int nIterations) {
    ...
    if (m_grid_graph) {
        switch (m_type) {
            case L1: optimize_GRID_L1(nIterations);
                break;
            case L2: optimize_GRID_L2(nIterations);
                break;
            case FIXED_MATRIX: optimize_GRID_FIXED_MATRIX(nIterations);
                break;
            case GENERAL: optimize_GRID_GENERAL(nIterations);
                break;
            case BINARY: optimize_GRID_BINARY(nIterations);
                break;
            default: assert(0);
                exit(1);
        }
